...
# Editar
botao_editar = driver.find_element("css selector", "a[href='/clientes/editar/7']")
botao_editar.click()
...
print("\nR1 - TESTAR REMOVER CLIENTE\n")
botao_remover = driver.find_element("id", "btn_clientes/excluirPorId/7")
botao_remover.click()
